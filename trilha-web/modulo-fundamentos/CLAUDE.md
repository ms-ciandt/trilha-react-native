# Módulo Fundamentos — Trilha Web

## Público-alvo

Devs React web sem experiência com mobile/React Native.
...
`modulo-recursos-nativos/` — recursos nativos do dispositivo (permissões, câmera, storage) e noções de integração nativa.
