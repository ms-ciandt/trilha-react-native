...
<video width="100%" controls>
  ...
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_ios/rec_04_sensors-and-device-apis.vtt" srclang="pt" label="Português" default>
...
Notificações push e notificações locais são abordadas separadamente em [Push e Notificações Locais](./push-notifications).
