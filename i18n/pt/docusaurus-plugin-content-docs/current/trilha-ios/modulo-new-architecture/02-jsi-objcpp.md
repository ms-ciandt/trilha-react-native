...
<video width="100%" controls>
  ...
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_ios/na_02_jsi-objcpp.vtt" srclang="pt" label="Português" default>
...
Para casos como processamento de imagem frame-a-frame, leitura de sensores de alta frequência, ou integração com Metal via buffers compartilhados, a diferença é a fronteira entre viável e inviavel.
...
- **Masterclass — Modulo 03: Fabric e JSI** (`docs/trilha-masterclass/modulo-03-fabric-jsi/`) — implementação de componentes Fabric com JSI, HostObjects avançados, integração com Metal e CoreML via buffers compartilhados, e analise de performance com Instruments.
