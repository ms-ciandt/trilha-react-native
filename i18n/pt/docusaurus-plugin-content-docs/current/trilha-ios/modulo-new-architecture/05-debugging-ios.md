...
<video width="100%" controls>
  ...
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_ios/na_05_debugging-ios.vtt" srclang="pt" label="Português" default>
...
<div className="trail-feedback trail-feedback--ios">
  ...
  <p className="trail-feedback-title">Você concluiu a Trilha iOS Native</p>
