...
<video width="100%" controls controlsList="nodownload">
  <source src="https://github.com/ms-ciandt/trilha-react-native/releases/download/v0-videos/fund_04_styling_stylesheet.mp4" type="video/mp4">
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_android/fund_04_styling_stylesheet.vtt" srclang="pt" label="Português" default>
