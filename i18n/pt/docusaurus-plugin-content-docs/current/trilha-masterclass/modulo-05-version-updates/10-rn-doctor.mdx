...
<div className="mc-feedback">
  ...
  <p className="mc-feedback-title">Voce concluiu a React Native Masterclass</p>
  <p className="mc-feedback-sub">Sua opiniao ajuda a melhorar o conteudo. Leva menos de 2 minutos.</p>
  <a
