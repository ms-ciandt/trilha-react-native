      ...
      {total > 0 && (
        <div className={styles.trailProgressBar}>
          <div className={styles.trailProgressInfo}>
            <span className={styles.trailProgressText}>{completed}/{total} lessons</span>
...
const REVIEWERS = [
  { name: 'Matheus Sales',             role: 'React Native', username: 'ms-ciandt', color: '#B4DCFA',  darkColor: null,      lightTextColor: '#5a8ab8', darkTextColor: '#B4DCFA' },
  ...
  return (
    <section className={styles.contributors}>
      ...
      <div className={styles.contributorsList}>
        {REVIEWERS.map(({ name, role, username, avatar, color, darkColor, lightTextColor, darkTextColor }, i) => {
          ...
          <div className={styles.masterclassContent}>
            ...
            <div className={styles.masterclassText}>
              ...
              <TrailCta
                ...
                startLabel="Access Masterclass"
                continueLabel="Continue Masterclass"
              />
            </div>
          </div>
        </section>
        ...
        <section className={styles.labsCallout}>
          ...
          <div className={styles.labsContent}>
            ...
            <div className={styles.labsText}>
              ...
              <div className={styles.labsLabel}>Put it into practice</div>
              <p className={styles.labsDesc}>
                Brownfield, native bridges, threads and more — five hands-on challenges to test your skills.
              </p>
