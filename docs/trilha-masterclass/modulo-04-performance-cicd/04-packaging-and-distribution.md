...
<video width="100%" controls controlsList="nodownload">
  ...
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_masterclass/mc04_04_packaging-and-distribution_en.vtt" srclang="en" label="English" default>
