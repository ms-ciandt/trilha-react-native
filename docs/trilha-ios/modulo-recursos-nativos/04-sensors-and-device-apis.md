...
<video width="100%" controls>
  ...
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_ios/rec_04_sensors-and-device-apis_en.vtt" srclang="en" label="English" default>
...
Push notifications and local notifications are covered separately in [Push and Local Notifications](./push-notifications).
