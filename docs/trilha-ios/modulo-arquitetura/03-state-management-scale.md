...
<video width="100%" controls>
  <source src="https://github.com/ms-ciandt/trilha-react-native/releases/download/v0-videos/arq_03_state-management-scale.mp4" type="video/mp4">
  <track kind="captions" src="/trilha-react-native/assets/captions/trilha_ios/arq_03_state-management-scale_en.vtt" srclang="en" label="English" default>
