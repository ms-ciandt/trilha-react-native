...
has one working screen: a list of internal tournaments (office soccer, pool, Mortal
Kombat, FIFA), each rendered as a card by `TournamentListScreen.kt`. Two more native
